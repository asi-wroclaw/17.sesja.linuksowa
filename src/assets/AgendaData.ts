export const SATURDAY_AGENDA = [
  ...
  },
  {
    ...
    description: [
      ...
      "",
      "Czemu wszędzie jest ten Javascript?!", "No właśnie, czemu? W swojej prezentacji (poza kodowaniem i sposobami publikacji) postaram się odpowiedzieć na to pytanie. Przez niecałą godzinę postaram się poruszyć też odpowiedzi na następujące pytania:",
      "",
